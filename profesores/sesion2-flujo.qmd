...
**Todo el vocabulario que necesitan:** el **repositorio** es la carpeta vigilada · una **versión** (*commit*) es una foto completa, con fecha y mensaje · el **diff** es la comparación entre dos fotos. [Y adiós a `paper_final_v2_AHORA_SI(3).docx`: un solo archivo, toda la historia.]{.muted}
