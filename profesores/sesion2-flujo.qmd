...
## Su turno: Plan Mode con material propio {.your-turn}
...
::: {.callout-note}
Cuando aprueben el plan, cambien a modo normal o auto-accept y déjenlo trabajar. Al final pidan: *"resúmeme todo lo que cambiaste"*.
:::
...
Lo que pasa detrás — un **equipo completo de asistentes** trabajando en paralelo:

![](../figures/es/deep-research-pipeline.svg){width=92% fig-align="center"}
...
# Bloque 3 — De sus datos a un dashboard

## La receta (en orden) {.smaller}
...
y, cuando lo apruebe, genera la versión limpia en datos-limpios/.
```

. . .

**Paso 2 — con la data limpia, el dashboard:**

```text
Con la data de datos-limpios/ y mi pregunta de investigación
[pregunta], créame un dashboard HTML: estadísticas descriptivas,
los gráficos clave y una breve explicación de cada uno.
```
...
un gráfico que responda mi pregunta de investigación.
```

**Qué observar:** cómo prueba, falla y **se corrige solo** hasta que el archivo compila. Ese ciclo — escribir, verificar, corregir — es lo que un chat no puede hacer.
