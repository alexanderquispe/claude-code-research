...
Cada punto de la línea es una **foto completa** de la carpeta, que se puede consultar o restaurar cuando haga falta. [Y adiós a `paper_final_v2_AHORA_SI(3).docx`: un solo archivo, toda la historia.]{.muted}
