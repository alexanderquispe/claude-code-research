...
| 8:20 – 8:30 | ☕ | Pausa 2 |
| 8:30 – 8:45 | 4 | Whisper: sus clases se vuelven material |
| 8:45 – 8:55 | 5 | MCPs: conectar Claude con su correo, Drive y más |
| 8:55 – 9:00 | — | Háblenle, no le tipeen + cierre |
...
Transcribí mi clase piloto con los asistentes del Q-LAB (97 min → **90 segundos**) y le pedí feedback:
...
[**La transcripción también se verifica:** del video del ejercicio, solo 33 de 491 fragmentos son habla — y escribe *"Anacocha"* por **Yanacocha**. Revisen cobertura y nombres propios antes de citar.]{.small .muted}

[Usos inmediatos: mejorar sus cursos, actas de asesorías, entrevistas de campo (con consentimiento), y los comentarios que reciben al presentar.]{.warm}

# Bloque 5 — MCPs: conectar Claude con sus otras apps

## Qué es un MCP {.smaller}

Hasta ahora Claude ve **su carpeta**. Pero su vida académica también vive en el correo, el calendario, el Drive…

. . .

Un **MCP** (*Model Context Protocol*) es un **enchufe estándar** que le da a Claude acceso — **con su permiso** — a otra aplicación. Piénsenlo como el USB de las apps: un conector universal.

- Se conecta **una sola vez**, con su login normal (el de Google, por ejemplo), guiados por el propio Claude: *"conéctame Gmail por MCP"*.
- Desde entonces, se pide **en español**, como todo lo de este taller.
- Es un estándar abierto — lo creó Anthropic y hoy lo usa toda la industria.

## Los que más les van a servir {.smaller}

| MCP | Qué le permite a Claude | Un pedido real |
|---|---|---|
| **Gmail** | Leer y buscar su correo; preparar borradores | *"Busca los correos del editor de la revista y dime en qué quedó la revisión"* |
| **Google Calendar** | Ver y crear eventos | *"Encuentra un hueco de 2 horas esta semana para el paper y resérvalo"* |
| **Google Drive** | Leer sus documentos compartidos | *"Lee los comentarios de mi coautora en el Drive y aplícalos al documento"* |
| **GitHub** | Traer paquetes de replicación publicados | *"El paquete de replicación de ese paper está en GitHub: descárgalo y explícamelo"* |
| **Zotero** *(comunidad)* | Su biblioteca de referencias | *"Agrega a mi Zotero los papers de papers/, con metadatos completos"* |

. . .

[Con `/mcp` dentro de Claude Code ven cuáles tienen conectados. Hay cientos más — el criterio: ¿dónde vive información que hoy le copian a mano?]{.small .muted}

## La letra chica (importa) {.smaller}

::: {.callout-warning}
## Conectar el correo es abrir la puerta de su correo
- Cada acción sensible (enviar, borrar, crear) **pide su permiso** — leer, no siempre. Conecten solo lo que necesitan.
- Solo en **su** computadora. Nunca conecten sus cuentas en una máquina compartida o del aula.
- Claude **nunca envía un correo sin mostrarles el borrador** — y si un MCP les pide la contraseña *en el chat*, algo anda mal: el login siempre ocurre en el navegador, en la página oficial.
:::

. . .

**El patrón de siempre, una vez más:** ustedes se loguean (el navegador, la página oficial); él opera con el acceso que ustedes le dieron — igual que con la biblioteca PUCP en la Sesión 1.
