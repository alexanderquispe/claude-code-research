...
## Cómo se lee un `.md` en VS Code {.smaller}

![](../figures/es/markdown-preview.svg){.nostretch width=78% fig-align="center"}

Abran el archivo y hagan clic en el **icono de vista previa** (arriba a la derecha): a la izquierda queda el texto con sus marcas, a la derecha **el documento ya formateado**.
