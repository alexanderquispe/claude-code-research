...
## Su turno 1 — la estructura del proyecto {.your-turn .smaller}

Casi ninguna carpeta de investigación está lista para enviarse a una revista. Pídanle el plan:
...
resultados, documento), nombres de archivo consistentes y sin
espacios, y un README que explique cómo reproducir todo.

Propónme primero el plan de reorganización — qué mueves, qué
renombras y por qué. No cambies nada todavía.
```
...
## Su turno 2 — los nombres de los archivos {.your-turn .smaller}

Ahora el detalle. Miren `papers/`: hay cosas como
