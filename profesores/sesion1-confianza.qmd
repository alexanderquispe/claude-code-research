...
**Por qué es así:** Claude nunca escribe contraseñas ni opera sesiones autenticadas por ustedes. No es una limitación técnica que se pueda saltar — es una regla de seguridad.

. . .

::: {.callout-tip}
Aun con ese reparto, el ahorro es enorme: la parte lenta no era hacer clic, era **saber qué buscar, dónde está y si la cita es correcta**.
:::
