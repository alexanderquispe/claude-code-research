...
## Bonus: la respuesta puede ser una página web {.smaller}

Al probar el tercer prompt en este proyecto pasó algo que no pedimos: como la explicación era "para compartir", Claude cargó uno de sus **skills** — manuales internos que activa cuando la tarea lo amerita. En el terminal se ve así:
...
Con esa guía de diseño cargada, publicó la explicación como una **página web con enlace propio** (un *Artifact*).

. . .

Para pedirlo a propósito, basta agregarlo al final:
...
- El enlace vive en claude.ai y es **privado hasta que ustedes decidan compartirlo**.
- Úsenlo para lo que antes era un Word adjunto: la guía de un proyecto para el nuevo asistente, el resumen para un coautor, el material de una clase.

[Del terminal salió una página lista para enviar — sin tocar Word ni PowerPoint.]{.warm}
...
![](../figures/es/deep-research-caso.svg){.nostretch width=88% fig-align="center"}
