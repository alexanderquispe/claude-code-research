...
| 6:50 – 7:10 | 3 | Ejercicio: diagnóstico de su computadora |
| 7:10 – 7:20 | ☕ | Pausa 1 |
...
- El **✓ verde** marca el modelo activo; se navega con las flechas ↑/↓.
- <kbd>Enter</kbd> lo fija como **default** para futuras sesiones · <kbd>s</kbd> lo usa **solo en esta sesión** · <kbd>Esc</kbd> cancela.
- ¿Y esa línea naranja de abajo, **"High effort"**? → siguiente slide.
...
- **Cómo se ajusta:** dentro del menú `/model`, con las flechas <kbd>←</kbd>/<kbd>→</kbd> (la línea naranja cambia: low · medium · high · …).
- **Recomendación del taller: déjenlo en High** (el default). El modelo además adapta solo cuánto piensa según la dificultad de cada pedido.
...
Presionen <kbd>Shift</kbd>+<kbd>Tab</kbd> varias veces ahora mismo y miren cómo **rota la etiqueta**. Para la clase de hoy déjenlo en **auto mode on** — así los ejercicios corren de corrido, sin detenerse en cada permiso.
