...
![](../figures/screenshots/cowork-app.png){.nostretch width=88% fig-align="center"}

**La misma cara que el chat, pero es una app instalada** — noten el botón **Cowork** activado y el selector *"Project or folder"*: el agente trabaja sobre una carpeta, **sin terminal**. Ideal para tareas de documentos — pero requiere **plan pago** ($20/mes o más).
