...
Al probar el tercer prompt en este proyecto pasó algo que no pedimos: como la explicación era "para compartir", Claude cargó uno de sus **skills** — manuales internos que activa cuando la tarea lo amerita, aquí el de diseño de páginas — y publicó la guía como una **página web con enlace propio** (un *Artifact*).
