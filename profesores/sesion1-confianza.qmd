...
- **manual mode on** — pregunta antes de **cada** acción. El modo de esta sesión.
- **accept edits on** — edita archivos sin preguntar; los comandos aún piden permiso.
- **auto mode on** — ejecuta ediciones **y** comandos solo. Únicamente en trabajo rutinario donde ya confían.
...
Presionen <kbd>Shift</kbd>+<kbd>Tab</kbd> varias veces ahora mismo y miren cómo **rota la etiqueta**. Déjenlo en **manual mode on** por hoy.
